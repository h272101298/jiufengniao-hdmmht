...
<!--         <el-form :inline="true" :model="form">
         ...
         <el-form-item>
          <el-input v-model="form.name" placeholder="请输入代理名称" style="min-width: 200px;" size="mini"></el-input>
        </el-form-item>
    ...
    <el-table :data="list" border stripe size="small" style="width: 1201px">
...
<script>
  ...
  import { withdrawCheck } from '../../api/api';
  ...
  export default {
    ...
    methods:{
      ...
      handleEdit(row){
        ...
        withdrawCheck(allParams).then((res) => {
          console.log(res)
          Message({
            message: "审核成功",
            type: 'success'
